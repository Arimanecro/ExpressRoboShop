...
module.exports = data => {
  data = chunk(data[Object.keys(data)[0]], 4);
  return `
    </nav><main>
    <section id="top" class="latest title_category_items">${data[0][0]["category"]
      .charAt(0)
      ...
      .map(
        ...
        ${v1.map(
          ...
          <article class="latest__item">
            <div class="latest__item__img" style="background:url(${v.img_medium.replace(/public/gi,
              ""
